        ...
        <div className="contact">
            ...
            <div className="contact-container">
                <div className="contact-left">
                    ...
                    <p>I'm graduating in 2023 and I'm interested in a full-time Software Developer , Front-End Developer or other technical profiles as per my skills. Please feel free to get in touch with me on any of the platforms.</p>
                    <PersonalContact />
                    <br />
                    <div className="download">
                    <a download href={require('../../../assets/myResume.pdf').default}>
